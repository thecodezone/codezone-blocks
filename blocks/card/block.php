...
<div
    ...
    <?php if ($background_image) : ?> --cz-card-background-position: <?= $background_position_left ? esc_attr($background_position_left) : 50 ?>% <?= $background_position_top ? esc_attr($background_position_top) : 50 ?>%; <?php endif; ?>
